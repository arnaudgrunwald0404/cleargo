...
COMMENT ON COLUMN app_settings.slack_channels IS 'Channel overrides for specific notification types (e.g., {"weekly_digest": "#leadership", "high_risk_alerts": "#alerts"})';
