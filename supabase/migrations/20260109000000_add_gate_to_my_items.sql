-- Add gate field to criterion JSONB in my_items_for_user function
-- Fix: Check decision_owner_id first (for delegated tasks), then fall back to criterion.decision_owner_email
-- Add parameter to show all items (including completed) or only pending items
