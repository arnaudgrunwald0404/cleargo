-- Non-gate criteria with CONDITIONAL status should disappear from the Home page pending view.
-- Only gate criteria remain visible when CONDITIONAL (since they can still block launch).
