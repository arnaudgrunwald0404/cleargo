-- 20260415200000_add_data_sources_to_my_items.sql
-- Include criterion.data_sources in the my_items_for_user response so
-- HomeDashboard can render the Docs column with source icons.
