-- Include NOT_APPLICABLE in pending view so tasks marked N/A stay visible and selection persists
-- (otherwise my_items_for_user with p_show_all=false excluded them and the row disappeared after refetch)
