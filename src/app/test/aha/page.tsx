...
import { Container, Title, Button, Stack, Paper, Text, Group, JsonInput, Select, TextInput, Alert, Code, Tabs } from '@mantine/core';
...
export default function AhaTestPage() {
  ...
  "estimated_ga_release_pm_owned": "2025-12-15"
    ...
    const getEpicFields = async () => {
        ...
        try {
            const response = await fetch(`/api/test/aha?action=fields&epicId=${encodeURIComponent(epicId)}`);
            const data = await response.json();
                ...
                <Tabs defaultValue="read">
                    ...
                    <Tabs.Panel value="read" pt="lg">
                        <Stack gap="md">
                            <Paper p="md" withBorder>
                                <Stack gap="md">
                                    <div>
                                        <Text fw={500} mb="xs">Connection Test</Text>
                            ...
                            <Paper p="md" withBorder>
                                <Stack gap="md">
                                    <div>
                                        <Text fw={500} mb="xs">List Products/Workspaces</Text>
                                        <Text size="sm" c="dimmed" mb="md">
                            ...
                            <Paper p="md" withBorder>
                                <Stack gap="md">
                                    <div>
                                        <Text fw={500} mb="xs">List Epics</Text>
                                        <Text size="sm" c="dimmed" mb="md">
                            ...
                            <Paper p="md" withBorder>
                                <Stack gap="md">
                                    <div>
                                        <Text fw={500} mb="xs">Get Epic Details</Text>
                                        <Text size="sm" c="dimmed" mb="md">
                    ...
                    <Tabs.Panel value="write" pt="lg">
                        <Paper p="md" withBorder>
                            <Stack gap="md">
                                <div>
                                    <Text fw={500} mb="xs">Write-Back Test</Text>
                                    <Text size="sm" c="dimmed" mb="md">
                                ...
                                <Alert color="blue" icon={<IconAlertCircle size={16} />}>
                                    <Text size="sm">
                                        ...
                                        <br />
                                        • estimated_ga_release_pm_owned (YYYY-MM-DD)
                                    </Text>
                                </Alert>

                                <Button
                                    onClick={testWriteBack}
                                    loading={loading}
                                    color="orange"
                                >
                                    Execute Write-Back
