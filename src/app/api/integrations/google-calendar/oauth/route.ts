    ...
    try {
        ...
        if (tokens.refresh_token) {
            ...
            if (existing?.refresh_token) {
                ...
                console.warn("No refresh token received and none exists in database. Access token will work until expiration.");
            }
        }
        ...
        return NextResponse.redirect(`${process.env.NEXT_PUBLIC_APP_URL || request.nextUrl.origin}/meetings?connected=true`);
    } catch (error: any) {
