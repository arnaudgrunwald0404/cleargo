...
export async function PATCH(req: NextRequest) {
  try {
    ...
    debugLog({
      location: 'api/settings/route.ts:PATCH',
      message: 'API received settings update',
      data: {
        hasAhaFields: 'aha_fields_to_load' in body,
        ahaFieldsFromRequest: body.aha_fields_to_load,
        hasDuplicatesInRequest: body.aha_fields_to_load
          ? new Set(body.aha_fields_to_load).size !== body.aha_fields_to_load.length
          : false,
      },
      hypothesisId: 'D',
    });
