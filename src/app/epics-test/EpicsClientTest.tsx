...
function EpicsClientTest({ initialEpics = [] }: EpicsClientProps) {
    ...
    return (
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8" style={{ fontFamily: "'Public Sans', sans-serif" }}>
            <Group align="flex-start" mb="sm">
                <Box>
                    <Title style={{ fontFamily: "'Atkinson Hyperlegible', sans-serif", color: "#111827", fontSize: "28px", fontWeight: 700 }}>Releases</Title>
                </Box>
            </Group>
                                ...
                                return (
                                    ...
                                    >
                                        <div className="space-y-2">
                                            ...
                                            <div className="pt-2 space-y-1 border-t" style={{ borderColor: "#E5E7EB" }}>
                                                <div className="flex justify-between text-sm">
                                                    <span style={{ color: "#6B7280", fontSize: "13px" }}>Epics loaded:</span>
                                                    <span className="font-medium" style={{ color: isSelected ? "#1E3A8A" : "#111827", fontSize: "13px" }}>
                                                        {stat.epicsLoaded}
                                                ...
                                                <div className="flex justify-between text-sm">
                                                    <span style={{ color: "#6B7280", fontSize: "13px" }}>High risk:</span>
                                                    <span className="font-medium" style={{ 
                                                        color: stat.highRiskCount > 0 ? '#EF4444' : '#6B7280',
                                                        fontSize: "13px"
                                                    }}>
                                                        {stat.highRiskCount}
                                                    </span>
            ...
            {filteredReleaseGroups.length === 0 ? (
                    <div className="rounded-lg overflow-hidden" style={{
                        ...
                        <div className="px-4 py-8 text-center" style={{ color: "#6B7280", fontSize: "14px" }}>
                            ...
                            <div key={groupIndex} className="space-y-2">
                                <div className="flex items-center justify-between gap-3">
                                    <h2 className="text-lg font-semibold" style={{
                                        ...
                                        {group.releaseName}
                                        {group.releaseDate ? (
                                            <span className="ml-2 text-base font-normal" style={{ color: "#6B7280", fontSize: "16px" }}>
                                                - {new Date(group.releaseDate).toLocaleDateString()}
                                            </span>
                                        ) : fetchingReleaseDates.has(group.releaseName) ? (
                                            <span className="ml-2 text-sm font-normal italic inline-flex items-center gap-1" style={{ color: "#6B7280", fontSize: "14px" }}>
...
export default EpicsClientTest;