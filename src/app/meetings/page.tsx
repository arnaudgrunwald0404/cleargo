        ...
        <div className="mb-8">
          ...
          {!isConnected && (
            <Alert icon={<IconAlertCircle size={16} />} color="blue" className="mb-6">
              ...
              to automatically detect check-in meetings. Meetings will be automatically linked to
              epics based on name matching.
            </Alert>
          )}
        </div>
              ...
              >
                ...
                {meeting.transcript?.[0] && (
                  <div className="mb-4">
                    ...
                    <Text
                      size="sm"
                      className="bg-gray-50 p-3 rounded border max-h-32 overflow-y-auto"
                    >
                          ...
                          <tbody className="bg-white divide-y divide-purple-200">
                            {group.epics.map((epic) => (
                              <tr key={epic.id} className="hover:bg-purple-50 transition-colors">
                                  ...
                                  <Checkbox
                                    ...
                                    onChange={(e) => {
                                      if (e.currentTarget.checked) {
                                        ...
                                        setSelectedEpicIds(
                                          selectedEpicIds.filter((id) => id !== epic.id)
                                        );
                                      }
                                    }}
                                  />
                                ...
                                <td className="px-4 py-3">
                                  <Text className="font-medium text-gray-900">{epic.name}</Text>
                                </td>
                              </tr>
                            ))}
                          </tbody>
