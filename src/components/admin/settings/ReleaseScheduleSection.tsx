            ...
            <table className="min-w-full divide-y divide-purple-200 table-fixed">
              ...
              <thead className="bg-purple-100">
                <tr>
                  ...
                  <th className="px-4 py-2 text-right text-xs font-medium text-purple-900">
                    Actions
                  </th>
                </tr>
              </thead>
            ...
            <table className="min-w-full divide-y divide-indigo-200 table-fixed">
              ...
              <thead className="bg-indigo-100">
                <tr>
                  ...
                  <th className="px-4 py-2 text-right text-xs font-medium text-indigo-900">
                    Actions
                  </th>
                </tr>
              </thead>
                      ...
                      <>
                        ...
                        <td className="px-4 py-3">
                          <span className="text-gray-600">
                            {formatDateForDisplay(release.launch_date)}
                          </span>
                        </td>
...
function ReleaseWithoutDateRow({
  ...
  const [dateInput, setDateInput] = useState(
    launchRelease.launchDate ? formatDateForInput(launchRelease.launchDate) : ''
  );
  return (
