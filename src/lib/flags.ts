...
/** AI-assisted epic Story Brief (day-one PM->PMM handoff, Aha/Jira delivery validation); off by default */
export const FEATURE_STORY_BRIEF = 'story_brief';
...
{ key: FEATURE_NOT_APPLICABLE, label: 'Not Applicable Go/No-Go Score', description: 'Fourth traffic light option; neutral to readiness; gating cannot be NA' },
  ...
  { key: FEATURE_STORY_BRIEF, label: 'Story Brief', description: 'AI-assisted epic Story Brief: Aha/Jira delivery validation + draft/edit/ratify workflow' },
] as const;
